import { LuShapes, LuCalendarDays, LuUsers, LuSettings } from "react-icons/lu";

const items = [
  {
    icon: <LuShapes size={96} />,
    title: "關於 FRC8569",
    description:
